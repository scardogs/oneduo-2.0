...
/**
 * Validates and sanitizes a CSS color value to prevent XSS.
 * Only allows valid CSS color formats: hex, rgb, rgba, hsl, hsla, or named colors.
 * @security This function is critical for preventing CSS injection attacks.
 */
const sanitizeCSSColor = (color: string): string | null => {
  ...
  // Allow common named colors (subset)
  const namedColors = [
...
/**
 * Escapes a string for safe use as a CSS identifier (used in selectors).
 */
const escapeCSSSelectorId = (id: string): string => {
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  const safeId = escapeCSSSelectorId(id);
  
  // Build CSS rules safely using sanitized values
  ...
  // Use a regular style element with textContent for safer injection
  // React will escape the content appropriately
